...
export default {
  ...
  auth: {
    ...
    login: {
      ...
      verification_required: 'Please check your email and verify your account first.',
    ...
    register: {
      register: 'Register',
      invalid_data: 'Server could not process the request. Please correct the sent data.',
      already_registered: 'Email address is already registered. Please check your email for verification.',
